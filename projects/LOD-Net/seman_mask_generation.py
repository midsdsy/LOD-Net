...
def main(args):
    ...
    args.weights = args.weights if args.weights is not None else "./outputs/LOD_R_101_FPN_1x/model_final.pth"
    args.output_path = args.output_path if args.output_path is not None else "./outputs/seman/LOD_R_101_FPN_1x_mstest_0.5/"
