...
class GeneralizedRCNNWithTTA(nn.Module):
    ...
    def _inference_one_image(self, input):
        ...
        # import pdb
        # pdb.set_trace()
        # torch.save(input, './outputs/vis_vectors/LOD_R_101_FPN_1x_no_mstest/image.pt')
        ...
        if self.cfg.MODEL.MASK_ON:
            ...
            merged_instances = detector_postprocess(merged_instances, *orig_shape)#double to binary
